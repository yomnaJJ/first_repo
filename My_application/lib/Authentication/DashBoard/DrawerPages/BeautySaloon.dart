...
class BeautySaloon extends StatefulWidget {
  BeautySaloon({Key key, this.userData}) : super(key: key);
  DocumentSnapshot<Map<String, dynamic>> userData;

  @override
  State<BeautySaloon> createState() => _BeautySaloonState();
}
class _BeautySaloonState extends State<BeautySaloon> {
  QuerySnapshot<Map<String, dynamic>> BeautySaloon;
  File selectedImage;
    ...
    if (BeautySaloon != null) {
      return Padding(
        ...
        child: ListView.builder(
            itemCount: BeautySaloon.docs.length,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: NetworkImage(BeautySaloon.docs[i]
                                        .data()['photoURL']),
                                    fit: BoxFit.fill)),
                          ),
                          Padding(
                                ...
                                Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        width: 253,
                                        child: Text(
                                          BeautySaloon.docs[i].data()['category'].toString(),
                                          style: GoogleFonts.andadaPro(
                                            color: Colors.white,
                                      ...
                                      SizedBox(
                                        width: 253,
                                        child: Text(
                                          BeautySaloon.docs[i].data()['name'].toString(),
                                          style: GoogleFonts.andadaPro(
                                            color: Colors.white,
                                      ...
                                      SizedBox(
                                        width: 253,
                                        child: Text(
                                          BeautySaloon.docs[i].data()['information'].toString(),
                                          style: GoogleFonts.andadaPro(
