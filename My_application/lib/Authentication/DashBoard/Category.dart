...
class Category extends StatefulWidget {
  Category({Key key, this.userData}) : super(key: key);
    ...
    if (Category != null) {
      return Padding(
        ...
        child: ListView.builder(
            itemCount: Category.docs.length,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: NetworkImage(Category.docs[i]
                                ...
                                Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        width: 253,
                                        child: Text(
                                          Category.docs[i].data()['category'].toString(),
                                          style: GoogleFonts.andadaPro(
                                            color: Colors.white,
                                      ...
                                      SizedBox(
                                        width: 253,
                                        child: Text(
                                          Category.docs[i].data()['name'].toString(),
                                          style: GoogleFonts.andadaPro(
                                            color: Colors.white,
                                      ...
                                      SizedBox(
                                        width: 253,
                                        child: Text(
                                          Category.docs[i].data()['information'].toString(),
                                          style: GoogleFonts.andadaPro(
